...
export default {
  ...
  topup: {
    ...
    amountTitle: '<b>أدخل مبلغ الإيداع (USD)</b>', amountMin: 'الحد الأدنى: USD {min}', amountMax: 'الحد الأقصى: USD {max}',
    amountHint: 'أرسل أرقامًا فقط، مثل <code>20</code>', method: '<i>طريقة الدفع: {name}</i>',
  ...
  pay: {
    ...
    cryptomus: {
      name: 'Cryptomus', btn: '🪙 الدفع بالعملات الرقمية · أي شبكة',
      open: '🔗 فتح صفحة الدفع',
  ...
  admin: {
    ...
    payBtn: { approve: '✅ موافقة · {amount}', reject: '❌ رفض' },
